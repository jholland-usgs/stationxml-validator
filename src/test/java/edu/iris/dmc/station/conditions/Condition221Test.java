...
public class Condition221Test {
	...
	@Test
	public void zeroLongitude() throws Exception {
		try (InputStream is = RuleEngineServiceTest.class.getClassLoader().getResourceAsStream("P1_221.xml")) {
