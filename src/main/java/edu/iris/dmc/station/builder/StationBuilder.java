...
public class StationBuilder {
	...
	public static Station build(B050 blockette) throws Exception {

		String code = blockette.getStationCode();
		...
		station.setLatitude(LatitudeBuilder.build(blockette.getLatitude()));
		station.setLongitude(LongitudeBuilder.build(blockette.getLongitude()));
