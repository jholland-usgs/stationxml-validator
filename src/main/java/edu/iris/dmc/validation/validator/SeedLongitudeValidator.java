...
public class SeedLongitudeValidator extends AbstractSeedValidator implements ConstraintValidator<Seed, Longitude> {
	...
	@Override
	public boolean isValid(Longitude value, ConstraintValidatorContext arg1) {
