...
import edu.iris.dmc.validation.validator.ElevationValidator;
...
@Constraint(validatedBy = { ElevationValidator.class })
public @interface Elevation {
	int id();
	String message() default "{station.channel.elevation}";
