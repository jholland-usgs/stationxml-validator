...
public class Comment {
    ...
    protected Date beginEffectiveTime;
    @XmlElement(name = "EndEffectiveTime")
   // @XmlSchemaType(name = "dateTime")
    @XmlJavaTypeAdapter(DateAdapter.class)
    protected Date endEffectiveTime;
     ...
     *     
     */
    public void setBeginEffectiveTime(Date value) {
     ...
     *     
     */
    public void setEndEffectiveTime(Date value) {
